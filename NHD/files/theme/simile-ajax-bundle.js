...
I.style.height="33px";
I.style.background="url("+SimileAjax.urlPrefix+"message-top-left.png) top left no-repeat";
I.style.paddingLeft="44px";
G.appendChild(I);
var C=H.createElement("div");
C.style.height="33px";
C.style.background="url("+SimileAjax.urlPrefix+"message-top-right.png) top right no-repeat";
I.appendChild(C);
var F=H.createElement("div");
F.style.background="url("+SimileAjax.urlPrefix+"message-left.png) top left repeat-y";
F.style.paddingLeft="44px";
G.appendChild(F);
var A=H.createElement("div");
A.style.background="url("+SimileAjax.urlPrefix+"message-right.png) top right repeat-y";
...
B.style.height="55px";
B.style.background="url("+SimileAjax.urlPrefix+"message-bottom-left.png) bottom left no-repeat";
B.style.paddingLeft="44px";
G.appendChild(B);
var E=H.createElement("div");
E.style.height="55px";
E.style.background="url("+SimileAjax.urlPrefix+"message-bottom-right.png) bottom right no-repeat";
B.appendChild(E);
...
var B=SimileAjax.Graphics.createTranslucentImage(SimileAjax.urlPrefix+"copy.png");
