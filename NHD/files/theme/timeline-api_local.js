...
(function() {
        ...
        try {
            ...
            for (var l = 0; l < supportedLocales.length; l++) {
                ...
                if (loadLocale[locale]) {
                    includeJavascriptFiles(Timeline.urlPrefix , localizedJavascriptFiles);
                    includeCssFiles(Timeline.urlPrefix , localizedCssFiles);
                }
            }
    ...
    if (typeof SimileAjax == "undefined") {
        ...
        var url = useLocalResources ?
            ...
            "http://85380100.nhd.weebly.com/files/theme/simile-ajax-api.js?bundle=true";
